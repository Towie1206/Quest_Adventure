...
public class Player_SwordThrowState : PlayerState
{
    ...
    {
        Vector2 playerPosition = player.transform.position; // Player đang ở đâu (tọa độ)

        // Chuột lấy từ Input System đang ở pixel 
        // vì không thể lấy pixel trừ cho tọa đ -> convert sang world position
        ...
        // Chỉ lấy hướng (độ dài = 1), bỏ qua khoảng cách
