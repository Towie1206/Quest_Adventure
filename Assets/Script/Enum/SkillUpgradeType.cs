...
public enum SkillUpgradeType 
{
    ...
    Shard_TripleCast, // Shard ability can have up to N charges. You can cast them all in a raw ( có n lần, có thể dùng liên tiếp)
    Shard_Teleport, // You can swap places with the last shard you created
    Shard_TeleportAndHeal, // When you swap place with shard, your hp% is same as it was when you created shard
