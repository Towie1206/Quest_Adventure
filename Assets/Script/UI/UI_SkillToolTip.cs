...
public class UI_SkillToolTip : UI_ToolTip
{
    ...
    public void ShowToolTip(bool show, RectTransform targetRect, UI_TreeNode node) // Overloaded method to show tooltip with skill node information
    {
        base.ShowToolTip(show, targetRect);
    ...
    public void LockedSkilLEffect()
    {
        if(textEffectCo != null)
            StopCoroutine(textEffectCo); //dừng coroutine trước khi bắt đầu một hiệu ứng mới để tránh xung đột
    ...
    private string GetRequirements(int skillCost, UI_TreeNode[] neededNodes, UI_TreeNode[] conflictNodes)
    {
        ...
        sb.AppendLine(); // spacing between requirements and conflicts
    ...
    protected override string GetColoredText(string color, string text)
    {
        return base.GetColoredText(color, text);
    }
